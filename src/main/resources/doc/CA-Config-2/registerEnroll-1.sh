...
# 注册org1的admin管理员 
fabric-ca-client register -d --id.name admin.org1.example.com --id.type admin --id.secret org1AdminPW -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register -d --id.name admin.org2.example.com --id.type admin --id.secret org2AdminPW -u https://root-admin:root-adminpw@0.0.0.0:7054

fabric-ca-client register --id.name peer0.org1.example.com --id.type peer  --id.secret=peer0org1pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name peer1.org1.example.com --id.type peer  --id.secret=peer1org1pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name peer0.org2.example.com --id.type peer  --id.secret=peer0org2pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name peer1.org2.example.com --id.type peer  --id.secret=peer1org2pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name orderer1.example.com --id.type orderer --id.secret=orderer1pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name orderer3.example.com --id.type orderer --id.secret=orderer3pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name orderer4.example.com --id.type orderer --id.secret=orderer4pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name orderer2.example.com --id.type orderer --id.secret=orderer2pw -u https://root-admin:root-adminpw@0.0.0.0:7054
fabric-ca-client register --id.name orderer5.example.com --id.type orderer --id.secret=orderer5pw -u https://root-admin:root-adminpw@0.0.0.0:7054
...
注册
fabric-ca-client register --id.name Admin@example.com --id.type admin --id.secret=ordereradminpw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
fabric-ca-client register --id.name orderer1.example.com --id.type orderer --id.secret=orderer1pw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
fabric-ca-client register --id.name orderer2.example.com --id.type orderer --id.secret=orderer2pw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
fabric-ca-client register --id.name orderer3.example.com --id.type orderer --id.secret=orderer3pw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
fabric-ca-client register --id.name orderer4.example.com --id.type orderer --id.secret=orderer4pw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
fabric-ca-client register --id.name orderer5.example.com --id.type orderer --id.secret=orderer5pw -u https://orderer-admin:orderer-adminpw@0.0.0.0:7055
...
fabric-ca-client register --id.name Admin@org1.example.com --id.type admin --id.secret=org1adminpw -u https://org1-admin:org1-adminpw@0.0.0.0:7056
fabric-ca-client register --id.name User1@org1.example.com --id.type client --id.secret=org1userpw  -u https://org1-admin:org1-adminpw@0.0.0.0:7056
fabric-ca-client register --id.name peer0.org1.example.com --id.type peer --id.secret=peer0org1pw -u https://org1-admin:org1-adminpw@0.0.0.0:7056
fabric-ca-client register --id.name peer1.org1.example.com --id.type peer --id.secret=peer1org1pw -u https://org1-admin:org1-adminpw@0.0.0.0:7056
...
注册
fabric-ca-client register --id.name Admin@org2.example.com --id.type admin --id.secret=org2adminpw -u https://org2-admin:org2-adminpw@0.0.0.0:7057
fabric-ca-client register --id.name User1@org2.example.com --id.type client --id.secret=org2userpw -u https://org2-admin:org2-adminpw@0.0.0.0:7057
fabric-ca-client register --id.name peer0.org2.example.com --id.type peer --id.secret=peer0org2pw -u https://org2-admin:org2-adminpw@0.0.0.0:7057
fabric-ca-client register --id.name peer1.org2.example.com --id.type peer --id.secret=peer1org2pw -u https://org2-admin:org2-adminpw@0.0.0.0:7057
