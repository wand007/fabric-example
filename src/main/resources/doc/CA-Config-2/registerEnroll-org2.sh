...
export FABRIC_CA_CLIENT_HOME=/etc/hyperledger/fabric-ca-server/admin
...
fabric-ca-client enroll -u https://Admin@org2.example.com:org2adminpw@org2.ca.example.com:7057
...
fabric-ca-client enroll -u https://User1@org2.example.com:org2userpw@org2.ca.example.com:7057
...
fabric-ca-client enroll -u https://peer0.org2.example.com:peer0org2pw@org2.ca.example.com:7057
...
fabric-ca-client enroll -u https://peer1.org2.example.com:peer1org2pw@org2.ca.example.com:7057
...
复制证书文件
1)  复制Admin@org2.example.com的msp证书
