...
mkdir ./crypto-config/ordererOrganizations/example.com/msp/tlscacerts
cp ./crypto-config/ordererOrganizations/example.com/orderers/orderer1.example.com/tls/tlscacerts/tls-root-ca-example-com-7054.pem ./crypto-config/ordererOrganizations/example.com/msp/tlscacerts/
