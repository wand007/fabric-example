...
export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org1/peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org1/ca/crypto/ca-cert.pem
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org1/peer1/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org1/peer1/tls-msp/keystore/key.pem


export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org1/peer2
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org1/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org1/peer2/tls-msp/keystore/*_sk  $FABRIC_CA_BASE_HOME/crypto-config/org1/peer2/tls-msp/keystore/key.pem


export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org1/admin
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org1/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
cp $FABRIC_CA_BASE_HOME/crypto-config/org1/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org1/peer2/msp/admincerts/org1-admin-cert.pem




export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org2/peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org2/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org2/peer1/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org2/peer1/tls-msp/keystore/key.pem


export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org2/peer2
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org2/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org2/peer2/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org2/peer2/tls-msp/keystore/key.pem




export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org2/admin
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org2/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/tls-msp/keystore/key.pem
mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/org2/peer1/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org2/peer1/msp/admincerts/org2-admin-cert.pem
mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/org2/peer2/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org2/peer2/msp/admincerts/org2-admin-cert.pem


## org0内的orderer节点制作证书

mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers


export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0/tls-msp/keystore/key.pem

export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/admin
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://admin-org0:org0adminpw@0.0.0.0:7053


mkdir $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0/msp/admincerts/orderer-admin-cert.pem




export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer2-org0
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer2-org0/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer2-org0/tls-msp/keystore/key.pem

mkdir $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer2-org0/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer2-org0/msp/admincerts/orderer-admin-cert.pem


export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer3-org0
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer3-org0/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer3-org0/tls-msp/keystore/key.pem

mkdir $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer3-org0/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer3-org0/msp/admincerts/orderer-admin-cert.pem



export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer4-org0
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer4-org0/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer4-org0/tls-msp/keystore/key.pem

mkdir $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer4-org0/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer4-org0/msp/admincerts/orderer-admin-cert.pem




export FABRIC_CA_CLIENT_HOME=$FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer5-org0
export FABRIC_CA_CLIENT_TLS_CERTFILES=$FABRIC_CA_BASE_HOME/crypto-config/org0/ca/crypto/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
mv $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer5-org0/tls-msp/keystore/*_sk $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer5-org0/tls-msp/keystore/key.pem

mkdir $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer5-org0/msp/admincerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp/signcerts/cert.pem $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer5-org0/msp/admincerts/orderer-admin-cert.pem
...
mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/configtx/org0
cp -r $FABRIC_CA_BASE_HOME/crypto-config/org0/admin/msp $FABRIC_CA_BASE_HOME/crypto-config/configtx/org0

mkdir $FABRIC_CA_BASE_HOME/crypto-config/configtx/org0/msp/tlscacerts
cp  $FABRIC_CA_BASE_HOME/crypto-config/org0/orderers/orderer1-org0/tls-msp/tlscacerts/tls-0-0-0-0-7052.pem  $FABRIC_CA_BASE_HOME/crypto-config/configtx/org0/msp/tlscacerts

## org1的admin证书
mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/configtx/org1
cp -r $FABRIC_CA_BASE_HOME/crypto-config/org1/admin/msp $FABRIC_CA_BASE_HOME/crypto-config/configtx/org1/

mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/configtx/org1/msp/tlscacerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org1/admin/tls-msp/tlscacerts/tls-0-0-0-0-7052.pem $FABRIC_CA_BASE_HOME/crypto-config/configtx/org1/tlscacerts

## org2的admin证书
mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/configtx/org2
cp -r $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/msp $FABRIC_CA_BASE_HOME/crypto-config/configtx/org2/

mkdir -p $FABRIC_CA_BASE_HOME/crypto-config/configtx/org2/msp/tlscacerts
cp $FABRIC_CA_BASE_HOME/crypto-config/org2/admin/tls-msp/tlscacerts/tls-0-0-0-0-7052.pem $FABRIC_CA_BASE_HOME/crypto-config/configtx/org2/tlscacerts
